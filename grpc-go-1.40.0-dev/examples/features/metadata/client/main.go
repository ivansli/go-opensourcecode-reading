...
func unaryCallWithMetadata(c pb.EchoClient, message string) {
	...
	//
	// unary RPC 可以在调用的时候，使用 CallOption Header 和 Trailer 来获取 metadata
...
func serverStreamingWithMetadata(c pb.EchoClient, message string) {
	...
	//
	// stream RPC 则可以直接使用 ServerStream 接口的方法 stream.Header() 获取metadata
	...
	//
	// stream RPC 则可以直接使用 ServerStream 接口的方法 stream.Trailer() 获取metadata
